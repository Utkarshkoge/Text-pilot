    ...
    return (
        <Box background="bg-surface-secondary" padding="400" borderRadius="200" borderWidth="025" borderColor="border">
            <BlockStack gap="300">
                ...
                <div style={{ overflowX: 'auto', backgroundColor: '#1a1a1a', padding: '16px', borderRadius: '8px', color: '#fff' }}>
            ...
            content: (
                <BlockStack gap="400">
                    ...
                    <Text as="p" variant="bodyMd">
                        ...
                        Our app automatically creates and manages specific <Text as="span" fontWeight="bold">Metaobjects</Text> in your Shopify store to hold all your translation data natively.
                    </Text>
                    <Box padding="400" background="bg-surface-warning" borderRadius="200">
                        <BlockStack gap="200">
                            <Text as="h3" variant="headingSm">⚠️ Critical Concept: Locale Matching</Text>
                            <Text as="p" variant="bodyMd">
                                The most important part of this integration is passing the <Text as="span" fontWeight="bold">correct locale code</Text> (e.g., 'en', 'fr', 'hi').
                                The locale code you pass from your Hydrogen storefront <Text as="span" fontWeight="bold">MUST exactly match</Text> the language definition saved in the Shopify metaobject by our app.
                                If they don't match, the GraphQL API will return nothing, and your translations won't work.
                            </Text>
                        </BlockStack>
                    </Box>
                </BlockStack>
        ...
        },
        {
            ...
            content: (
                <BlockStack gap="400">
                    ...
                    <Text as="p" variant="bodyMd">
                        Notice how the GraphQL query searches for the metaobject where the <Text as="span" fontWeight="bold">display_name</Text> matches the requested locale key. This is why locale matching is strictly required!
                    </Text>
                </BlockStack>
            ),
